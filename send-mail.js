...
function sendSampleMail(auth, cb) {
  ...
  email_lines.push('From: "Dear Juani..." <aguspermadi94@gmail.com>');
  email_lines.push('To: anthonyjuan95@gmail.com');
  email_lines.push('Content-type: text/html;charset=iso-8859-1');
  email_lines.push('MIME-Version: 1.0');
  email_lines.push('Subject: Ini email buat belajar coy .. ');
  email_lines.push('');
